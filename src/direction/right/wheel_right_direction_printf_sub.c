...
** File description:
** wheel_right_direction_printf_sub
*/

#include "my_project.h"

static int wheel_right_direction_printf_eight(int value1, int value2,
...
static int wheel_right_direction_printf_seven(int value1, int value2,
my_project_t *my_project_n, int len_wall)
{
    if (len_wall < 300){
        if (wheel_right_direction_printf_eight(value1, value2, my_project_n,
        len_wall) == 0)
            return 0;
...
{
    if (len_wall < 400){
        if (wheel_right_direction_printf_seven(value1, value2, my_project_n,
        len_wall) == 0)
            return 0;
